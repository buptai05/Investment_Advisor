from AIQuestions import SystemQuestions, AgeQuestion, StageOfLifeQuestion, IncomePercentageQuestion
...
def runScript():
    ...
    total_score += SystemQuestions.get_financial_knowledge_score()
